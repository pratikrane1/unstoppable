...
class _BuyingRequirmentSubmitState extends State<BuyingRequirmentSubmit> {
  ...
  void initState() {
    ...
    _allBuyingRequirementBloc =
        BlocProvider.of<ManageAllBuyingRequirementBloc>(context);
  }
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                                  ...
                                  child: FutureBuilder<List<SubCategoryModel>>(
                                      future: fetchSubCategory(
                                          categoryModelselected != null
                                              ? categoryModelselected!.catId
                                              .toString()
                                              : "No Sub Category Available"),
                                      builder: (BuildContext context,
                                          AsyncSnapshot<List<SubCategoryModel>>
                                          snapshot) {
                                        if (!snapshot.hasData) return Container();
                                                    ...
                                                    child: DropdownButton(
                                                        ...
                                                        hint: Text(
                                                            ...
                                                            style: TextStyle(
                                                                color: Color(
                                                                    0xFF3F4141))),
                                                        value: subcategoryModelselected ==
                                                            null
                                                            ? subcategoryModelselected
                                                            : snapshot.data!
                                                            .where((i) =>
                              ...
                              Column(
                                children: [
                                  Align(
                                      alignment: Alignment.topLeft,
                                      child: Text('Approximate Other Value (Rs.) :')),
                                  SizedBox(
                                    height: 5,
                                  ),
                        ...
                        BlocBuilder<ManageAllBuyingRequirementBloc, ManageAllBuyingRequirementState>(
                            builder: (context, manageform) {
                              return BlocListener<ManageAllBuyingRequirementBloc, ManageAllBuyingRequirementState>(
                                listener: (context, state) {
                                  if (state is SaveBuyingRequiementForm) {
                                    ...
                                    child: AppButton(
                                      onPressed: () async {
                                        if (_ProdNameController == null) {
                                          ...
                                          _allBuyingRequirementBloc!
                                              .add(SaveBuyingRequirementForm(
                                            userid: Application.vendorLogin!.userId
                                                .toString(),
                                            categoryId:
                                            categoryModelselected!.catId.toString(),
                                            subCateId: subcategoryModelselected!
                                                .subcatId
                                                .toString(),
