...
class CompanyProfileEditPage extends StatefulWidget {
  ...
  CompanyProfileEditPage({Key? key, required this.companyData})
      : super(key: key);
  @override
...
class _CompanyProfileEditPageState extends State<CompanyProfileEditPage> {
  ...
  void initState() {
    ...
    _companyProbileBloc!.add(OnLoadingCompanyProfileList(
  ...
  void setData() {
    setState(() {
      ...
      _operatorDesignation.text =
          widget.companyData!.operatorDesignation.toString();
                                          ...
                                          Column(
                                            children: [
                                              Align(
                                                  alignment: Alignment.topLeft,
                                                  child: Text(
                                                      'Company Name (as per Reg. documents)')),
                                              SizedBox(
                                                height: 5,
                                              ),
                                              TextFormField(
                                              ...
                                              TextFormField(
                                                ...
                                                validator: (value) {
                                                  ...
                                                  if(value==null || value.isEmpty){
                                                    ...
                                                    return 'Please enter valid Alternate Email';
                                                  }
                                                  return null;
                                                },
                                                onChanged: (value) {
                ...
                BlocBuilder<CompanyProfileBloc, CompanyProfileState>(
                  ...
                  return BlocListener<CompanyProfileBloc, CompanyProfileState>(
                      listener: (context, state) {
                        if (state is UpdateCompanyProfileSuccess) {
                        ...
                        if (state is UpdateCompanyProfileFail) {
                          // companyData=[];
                          // setData(companyData!);
                          // setData();
