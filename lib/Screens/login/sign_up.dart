                          ...
                          child: Column(
                            children: [
                              ...
                              const Align(alignment: Alignment.topLeft,
                                  child: Text(
                                    "Full Name:", textAlign: TextAlign.start,)),
                              const SizedBox(height: 5,),
                              SizedBox(
                                width: MediaQuery
                                    .of(context)
                                                    ...
                                                    child: DropdownButton(
                                                        ...
                                                        hint: Text(
                                                            ...
                                                            style: TextStyle(
                                                                color: Color(
                                                                    0xFF3F4141))),
                                                        value: subsubcategoryModelselected ==
                                                            null
                                                            ? subsubcategoryModelselected
                                                            : snapshot.data!
                                                            .where((i) =>
                              ...
                              Align(alignment: Alignment.topLeft,
                                  child: (_value == "5" || _value == "7")
                                      ?
                                  Text(
                                    "PAN Number:", textAlign: TextAlign.start,)
                                      :
                                  Text(
                                    "GST Number:", textAlign: TextAlign.start,)
                              ),
                              const SizedBox(height: 5,),
                              SizedBox(
                                width: MediaQuery
                              ...
                              const Align(alignment: Alignment.topLeft,
                                  child: Text(
                                    "Pin Code:", textAlign: TextAlign.start,)),
                              const SizedBox(height: 5,),
                              SizedBox(
                                width: MediaQuery
                                    .of(context)
                              ...
                              const Align(alignment: Alignment.topLeft,
                                  child: Text(
                                    "Mobile No:", textAlign: TextAlign.start,)),
                              const SizedBox(height: 5,),
                              SizedBox(
                                width: MediaQuery
                                    .of(context)
                              ...
                              // For Upload image
                              const Align(alignment: Alignment.topLeft,
                                  child: Text("Company Logo(optional):",
                                    textAlign: TextAlign.start,)),
                              const SizedBox(height: 5,),
                              Padding(
                              ...
                              child: AppButton(
                                onPressed: () async {
                                  ...
                                  if (isconnectedToInternet == true) {
                                    ...
                                    if (_establishmentController == null) {
                                      Fluttertoast.showToast(
                                    ...
                                    if (subsubcategoryModelselected == null) {
                                      Fluttertoast.showToast(
                                          msg: "Please select SubSub Category");
                                    } else
                                    if (_formKey.currentState!.validate()) {
                                      _userLoginBloc!.add(OnRegistration(
                                        ...
                                        catId: categoryModelselected!.catId
                                            .toString(),
                                        subId: subcategoryModelselected!
                                            .subcatId
                                            .toString(),
                                        subSubId: subsubcategoryModelselected!
                                            .sscatId
                                            .toString(),
