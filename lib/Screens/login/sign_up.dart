    ...
    if (_image != null && imageFile != null) {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: ThemeColors.textFieldBgColor, // red as border color
          ),
          color: Colors.white,
        ),
        child: ClipRRect(
                        ...
                        children: [
                                                ...
                                                child: DropdownButton(
                                                    ...
                                                    value: subcategoryModelselected == null
                                                        ...
                                                        : snapshot.data!
                                                            .where((i) =>
                                                                i.subCatName ==
                                                                subcategoryModelselected!.subCatName)
                          ...
                          Padding(
                              ...
                              child: FutureBuilder<List<SubSubCategoryModel>>(
                                  future: fetchSubSubCategory(
                                      subcategoryModelselected != null
                                          ? subcategoryModelselected!.subcatId
                                              .toString()
                                          : ""),
                                  builder: (BuildContext context,
                                      AsyncSnapshot<List<SubSubCategoryModel>>
                                          snapshot) {
                                    if (!snapshot.hasData) return Container();
                                                ...
                                                child: DropdownButton(
                                                    ...
                                                    value: subsubcategoryModelselected == null
                                                        ...
                                                        : snapshot.data!
                                                            .where((i) =>
                                                                i.ssCatName ==
                                                                subsubcategoryModelselected!.ssCatName)
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  ...
                                  return 'Please enter valid Year of establishment';
                          ...
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter Total no. of employees ';
                                }
                                return null;
                              },
                              onChanged: (value) {
                          ...
                          SizedBox(
                            ...
                            child: (_value == "5" || _value == "7")
                                ...
                                : TextFormField(
                                    ...
                                    validator: (value) {
                                      Pattern pattern= "^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}";
                                      RegExp regex =
                                      new RegExp(pattern.toString());
                ...
                return BlocListener<LoginBloc, LoginState>(
                  ...
                  child: Padding(
                    ...
                    child: AppButton(
                      ...
                      text: 'Register',
                      loading: signup is VendorRegistrationLoading,
