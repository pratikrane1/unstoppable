...
class BusinessNetworkingContact extends StatefulWidget{
  String? rowId;
  GetBNCmodel bnCmodel;

  BusinessNetworkingContact({Key? key, required this.rowId, required this.bnCmodel}) : super(key: key);
                                 ...
                                 else if(_formKey.currentState!.validate())
                                {
                                  ...
                                  { //add api
                                    _businessOpprtunityBloc!.add(UpdateBNC(
                                      ...
                                      type: typeValue,
                                      rowid: widget.bnCmodel.row.toString(),
                                      id: widget.bnCmodel.id.toString() ,
